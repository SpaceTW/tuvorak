...
function loadAsset(faceLink, backLink)
	...
	endIndex = endIndex+1
	--print(string.sub(faceLink, startIndex, endIndex))
	local deckHeight = tonumber(string.sub(faceLink, startIndex, endIndex))
	startIndex = endIndex+2
	local ignore, endIndex = string.find(faceLink, '%)')
	--print(string.sub(faceLink, startIndex, endIndex-1))
	local numCards = tonumber(string.sub(faceLink, startIndex, endIndex-1))
	
	--print(deckWidth .. ' ' .. deckHeight .. ' ' .. numCards)
	
	startIndex, endIndex = string.find(backLink, '%(.*%)')
	--print(startIndex)
	local backSheet = true
